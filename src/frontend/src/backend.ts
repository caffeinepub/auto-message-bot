...
export class Backend implements backendInterface {
    ...
    async createRule(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createRule(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async createTemplate(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setFallback(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setFallback(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleBot(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleBot(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRule(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRule(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTemplate(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
